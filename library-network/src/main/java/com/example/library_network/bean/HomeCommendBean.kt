 ...
 */
@Entity
data class HomeCommendBean(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) {
    ...
    data class Data(
        ...
        val webAdTrack: Any,
        val webUrl: WebUrl,
        val detail: HomeDiscoveryBean.AutoPlayVideoAdDetail?
    )
