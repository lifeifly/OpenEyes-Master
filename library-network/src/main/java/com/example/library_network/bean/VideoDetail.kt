...
import com.example.librery_base.model.IBaseModelListener
 ...
 * @since  2020/5/14
 */
data class VideoRelated(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) :IBaseModelListener {
 ...
 * @since  2020/5/14
 */
data class VideoReplies(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) : IBaseModelListener {
